<template>
  <div class="message-board">
    <div class="control">
      ...
      <el-button type="primary" size="small" @click="wantMessage">我要留言</el-button>
    ...
    <el-dialog title="添加留言" :visible.sync="isAdd" align="center">       
      <el-form :model="formBoard" label-width="80px" size="small">
        <el-form-item label="昵称:" prop="nickName">
          <el-input v-model.trim="formBoard.nickName" placeholder="请输入昵称"></el-input>
        </el-form-item>
        <el-form-item label="内容:" prop="content">
          <el-input type="textarea" v-model.trim="formBoard.content" placeholder="请输入内容"></el-input>
        </el-form-item>
        <el-form-item label="日期:" prop="date">
          <el-date-picker style="width: 100%;" type="datetime" v-model="formBoard.date" placeholder="选择日期"></el-date-picker>            
        </el-form-item>
        <el-form-item label="民族:" prop="nation">
          <el-select style="width: 100%;" v-model="formBoard.nation" placeholder="选择民族">
            <el-option v-for="formBoard in nationOption" :key="formBoard.id" :label="formBoard.name" :value="formBoard.name"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="性别:" prop="sex">
          <el-select style="width: 100%;" v-model="formBoard.sex" placeholder="选择性别">
            <el-option v-for="formBoard in sexOption" :key="formBoard.id" :label="formBoard.gender" 
              :value="formBoard.gender">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="证件类型:" prop="idCard">
          <el-select style="width: 100%;" v-model="formBoard.idCard" placeholder="选择证件类型">
            <el-option v-for="formBoard in idOption" :key="formBoard.id" :label="formBoard.name" 
              :value="formBoard.name">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="籍贯:" prop="nativePlace">
          <el-cascader :props="addProp" style="width: 100%" v-model="formBoard.nativePlace" 
            :options="provinceOption" placeholder="选择籍贯">
          </el-cascader> 
        </el-form-item>
        <el-form-item label="婚姻状况:" prop="marriage" align="left">
          <el-radio-group v-model="formBoard.marriage">
            <el-radio v-for="formBoard in marriageOption" :key="formBoard.id" :label="formBoard.label" :value="formBoard.label" border></el-radio>
          </el-radio-group>
        </el-form-item>
    ...
    <el-card class="table-board">
      ...
      <el-table :data="search(keyword)" @selection-change="selectChange" :row-style="rowStyle">
      <!-- <el-table :data="searchList" @selection-change="selectChange" :row-style="rowStyle"> -->
        <el-table-column type="selection" align="center"></el-table-column>
        <el-table-column prop="nickName" label="昵称" align="center"></el-table-column>
        <el-table-column prop="content" label="内容" align="center"></el-table-column>
        <el-table-column prop="date" label="日期" align="center" :formatter="formatter" width="200"></el-table-column>
        <el-table-column prop="nation" label="民族" align="center" width="60"></el-table-column>
        <el-table-column prop="sex" label="性别" align="center" width="60"></el-table-column>
        <el-table-column prop="idCard" label="证件类型" align="center"></el-table-column>
        <el-table-column prop="nativePlace" label="籍贯" align="center"></el-table-column>
        <el-table-column prop="marriage" label="婚姻状况" align="center" width="80"></el-table-column>
        <el-table-column prop="status" label="留言状态" align="center" width="80">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button @click="eidtBoard(scope.$index, scope.row)" :style="{color: scope.row.status === 1 ? '' : '#ccc'}" type="text">修改</el-button>
            ...
            <el-button @click="deleteBoard(scope.row.id)" :style="{color: scope.row.status === 1 ? '' : '#ccc'}" class="delete" type="text">删除</el-button>
            <el-button @click="stateSwitch(scope.row)" :style="{color: scope.row.status === 1 ? '' : '#f00'}" type="text">
    ...
    <el-dialog title="修改留言" :visible.sync="isEdit" align="center">
      <el-form :model="modifyBoard" label-width="80px" size="small">
        <el-form-item label="昵称:" prop="nickName">
          <el-input v-model.trim="modifyBoard.nickName" placeholder="修改昵称"></el-input>
        </el-form-item>
        <el-form-item label="内容:" prop="content">
          <el-input type="textarea" v-model.trim="modifyBoard.content" placeholder="修改内容"></el-input>
        </el-form-item>
        <el-form-item label="日期:" prop="date">
          <el-date-picker style="width: 100%;" type="datetime" v-model="modifyBoard.date" placeholder="选择日期"></el-date-picker>
        </el-form-item>
        <el-form-item label="民族:" prop="nation">
          <el-select style="width: 100%;" v-model="modifyBoard.nation" placeholder="选择民族">
            <el-option v-for="modifyBoard in nationOption" :key="modifyBoard.id" :label="modifyBoard.name" 
              :value="modifyBoard.name">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="性别:" prop="sex">
          <el-select style="width: 100%;" v-model="modifyBoard.sex" placeholder="选择性别">
            <el-option v-for="modifyBoard in sexOption" :key="modifyBoard.id" :label="modifyBoard.gender" 
              :value="modifyBoard.gender">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="证件类型:" prop="idCard">
          <el-select style="width: 100%;" v-model="modifyBoard.idCard" placeholder="选择证件类型">
            <el-option v-for="modifyBoard in idOption" :key="modifyBoard.id" :label="modifyBoard.name" 
              :value="modifyBoard.name">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="籍贯:" prop="nativePlace">
          <el-cascader :props="modifyProp" style="width: 100%" v-model="modifyBoard.nativePlace" 
            :options="provinceOption" placeholder="选择籍贯">
          </el-cascader> 
        </el-form-item>
        <el-form-item label="婚姻状况:" prop="marriage" align="left">
          <el-radio-group v-model="modifyBoard.marriage">
            <el-radio v-for="modifyBoard in marriageOption" :key="modifyBoard.id" :label="modifyBoard.label" 
              :value="modifyBoard.label" border>
            </el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item align="right">
