	...
	<div class="cart">
      ...
      <el-table-column label="数量" width="180" align="center">
        <template slot-scope="scope">
          <el-input-number @input="handleBlur" @change="handleChange(scope.row)" :value="scope.row.num" :min="1" size="mini"></el-input-number>
        </template>
      </el-table-column>
      <el-table-column prop="price" label="单价" width="180" align="center"></el-table-column>
      <el-table-column prop="total_num" label="小计" width="180" align="center"></el-table-column>
      <el-table-column label="操作" width="180" align="center">
        <template slot-scope="scope">
          <el-button @click="handleDelete(scope.row)" type="danger" plain icon="el-icon-delete" size="mini">删除</el-button>
        </template>
      </el-table-column>
		</el-table>
		<info v-if="totalNum" />
		<el-dialog title="注意" :visible.sync="dialogVisible" width="20%" align="center">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button @click="dialogConfirm" type="primary" size="small">确 定</el-button>
      </div>
		</el-dialog>
	</div>
</template>
