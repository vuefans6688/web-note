  ...
  methods: {
    ...
    drawLine(ctx) {
      ...
      for (let i = 0; i < 8; i++) {
        ...
        ctx.moveTo(this.randomNumber(0, this.contentWidth), this.randomNumber(0, this.contentHeight))  // 设置起点x, y
        ctx.lineTo(this.randomNumber(0, this.contentWidth), this.randomNumber(0, this.contentHeight))  // 绘制直线 x, y 一条当前位置到x, y点的直线
    ...
    drawDot(ctx) {
      ...
      for (let i = 0; i < 100; i++) {
        ...
        ctx.arc(this.randomNumber(0, this.contentWidth), this.randomNumber(0, this.contentHeight), 1, 0, 2 * Math.PI)
